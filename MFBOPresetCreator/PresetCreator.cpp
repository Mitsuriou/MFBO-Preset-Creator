...
void PresetCreator::loadProject(const QString& lFilePath, const bool aSkipFileChooser)
{
  ...
  if (!aSkipFileChooser)
  {
    ...
    const auto lContextPath{Utils::GetPathFromKey(this->mLastPaths,
                                                  QStringLiteral("lastLoadedProject"),
                                                  QStandardPaths::writableLocation(QStandardPaths::DesktopLocation),
                                                  this->mSettings.general.eachButtonSavesItsLastUsedPath)};
    lFileToLoad = QFileDialog::getOpenFileName(this, "", lContextPath, tr("Preset Creator Project (*.pcp *.json)"));
  }

  if (lFileToLoad.isEmpty())
  {
    return;
  }
...
void PresetCreator::saveProject(const bool aIsSaveAsContext)
{
  ...
  if (aIsSaveAsContext || (!aIsSaveAsContext && this->mLastUsedSavePath.isEmpty()))
  {
    ...
    const auto lContextPath{Utils::GetPathFromKey(this->mLastPaths,
                                                  ...
                                                  QStandardPaths::writableLocation(QStandardPaths::DesktopLocation),
                                                  this->mSettings.general.eachButtonSavesItsLastUsedPath)};
    lFilePath = QFileDialog::getSaveFileName(this, "", lContextPath, tr("Preset Creator Project (*.pcp *.json)"));
...
void PresetCreator::injectDataFromOSPFile()
{
  ...
  const auto lContextPath{Utils::GetPathFromKey(this->mLastPaths,
                                                ...
                                                QStandardPaths::writableLocation(QStandardPaths::DesktopLocation),
                                                this->mSettings.general.eachButtonSavesItsLastUsedPath)};
  auto lFileToLoad{QFileDialog::getOpenFileName(this, "", lContextPath, tr("BodySlide OSP file (*.osp)"))};
...
void PresetCreator::fillUIByAssistedConversionValues(QString aPresetName, std::vector<Struct::AssistedConversionResult> aResultsList)
{
  ...
  // Set the preset name
  this->findChild<QLineEdit*>(QStringLiteral("names_osp_xml_input"))->setText(aPresetName);
  this->findChild<QLineEdit*>(QStringLiteral("names_bodyslide_input"))->setText(aPresetName);
  ...
  for (const auto& lResult : aResultsList)
  {
    ...
    switch (lRole)
    {
      case AssistedConversionRole::BODY:
        this->findChild<QLineEdit*>(QStringLiteral("meshes_path_input_femalebody"))->setText(lResult.getPath());
        this->findChild<QLineEdit*>(QStringLiteral("body_mesh_name_input"))->setText(lResult.getName());

        lBodiesHaveBeenSet = true;
        break;
      case AssistedConversionRole::FEET:
        this->findChild<QLineEdit*>(QStringLiteral("meshes_path_input_femalefeet"))->setText(lResult.getPath());
        this->findChild<QLineEdit*>(QStringLiteral("feet_mesh_name_input"))->setText(lResult.getName());

        lFeetHaveBeenSet = true;
        break;
      case AssistedConversionRole::HANDS:
        this->findChild<QLineEdit*>(QStringLiteral("meshes_path_input_femalehands"))->setText(lResult.getPath());
        this->findChild<QLineEdit*>(QStringLiteral("hands_mesh_name_input"))->setText(lResult.getName());

        lHandsHaveBeenSet = true;
        break;
      case AssistedConversionRole::SKELETON:
      {
        auto lNeedCustomSkeleton{this->findChild<QCheckBox*>(QStringLiteral("use_custom_skeleton"))};
        if (!lNeedCustomSkeleton->isChecked())
        {
          lNeedCustomSkeleton->setChecked(true);
        }

        this->findChild<QLineEdit*>(QStringLiteral("skeleton_path_directory"))->setText(lResult.getPath());
        this->findChild<QLineEdit*>(QStringLiteral("skeleton_name"))->setText(lResult.getName());
  ...
  if (!lBodiesHaveBeenSet || !lFeetHaveBeenSet || !lHandsHaveBeenSet)
  {
        ...
        == ButtonClicked::YES)
    {
      ...
      if (!lBodiesHaveBeenSet)
      {
        this->findChild<QLineEdit*>(QStringLiteral("meshes_path_input_femalebody"))->setText("");
        this->findChild<QLineEdit*>(QStringLiteral("body_mesh_name_input"))->setText("");
      }

      // Clear the feet path
      if (!lFeetHaveBeenSet)
      {
        this->findChild<QLineEdit*>(QStringLiteral("meshes_path_input_femalefeet"))->setText("");
        this->findChild<QLineEdit*>(QStringLiteral("feet_mesh_name_input"))->setText("");
      }

      // Clear the hands path
      if (!lHandsHaveBeenSet)
      {
        this->findChild<QLineEdit*>(QStringLiteral("meshes_path_input_femalehands"))->setText("");
        this->findChild<QLineEdit*>(QStringLiteral("hands_mesh_name_input"))->setText("");
      }
    }
  }
  ...
  {
    this->findChild<QCheckBox*>(QStringLiteral("use_custom_skeleton"))->setChecked(true);
    this->findChild<QLineEdit*>(QStringLiteral("skeleton_path_directory"))->setText("");
    this->findChild<QLineEdit*>(QStringLiteral("skeleton_name"))->setText("skeleton_female");
    this->findChild<QCheckBox*>(QStringLiteral("use_custom_skeleton"))->setChecked(false);
  }
}
...
void PresetCreator::setupBodyMeshesGUI(QGridLayout& aLayout)
{
  ...
  lMeshesPathFemaleBodyLineEdit->setObjectName(QStringLiteral("meshes_path_input_femalebody"));
  ...
  lBodyMeshNameInput->setObjectName(QStringLiteral("body_mesh_name_input"));
  ...
  lMeshesPathFemaleFeetLineEdit->setObjectName(QStringLiteral("meshes_path_input_femalefeet"));
  ...
  lFeetMeshNameInput->setObjectName(QStringLiteral("feet_mesh_name_input"));
  ...
  lMeshesPathFemaleHandsLineEdit->setObjectName(QStringLiteral("meshes_path_input_femalehands"));
  ...
  lHandsMeshNameInput->setObjectName(QStringLiteral("hands_mesh_name_input"));
  ...
  lMeshesPreview->setObjectName(QStringLiteral("meshes_preview"));
  ...
  lLabelBeastHands->setObjectName(QStringLiteral("label_use_beast_hands"));
...
void PresetCreator::setupSkeletonGUI(QGridLayout& aLayout)
{
  ...
  lLabelSkeletonChooser->setObjectName(QStringLiteral("label_skeleton_chooser"));
  ...
  lSkeletonChooser->setObjectName(QStringLiteral("skeleton_chooser"));
  ...
  lLabelSkeletonPath->setObjectName(QStringLiteral("label_skeleton_path_directory"));
  lSkeletonGridLayout->addWidget(lLabelSkeletonPath, 2, 0);

  auto lSkeletonPathLineEdit{new LineEdit(this)};
  lSkeletonPathLineEdit->setObjectName(QStringLiteral("skeleton_path_directory"));
  ...
  lSkeletonNameLabel->setObjectName(QStringLiteral("label_skeleton_female"));
  lSkeletonGridLayout->addWidget(lSkeletonNameLabel, 3, 0);

  auto lSkeletonName{new LineEdit(this)};
  lSkeletonName->setObjectName(QStringLiteral("skeleton_name"));
  ...
  lSkeletonNameExtension->setObjectName(QStringLiteral("skeleton_name_extension"));
  ...
  lSkeletontitlePreview->setObjectName(QStringLiteral("label_skeleton_path_preview"));
  lSkeletonGridLayout->addWidget(lSkeletontitlePreview, 4, 0);

  auto lSkeletonPathsPreview{new QLabel(this)};
  lSkeletonPathsPreview->setObjectName(QStringLiteral("skeleton_path_preview"));
...
{
  // Body Meshes
  this->findChild<QLineEdit*>(QStringLiteral("meshes_path_input_femalebody"))->setText(lFile["meshes_path_input_femalebody"].toString());
  this->findChild<QLineEdit*>(QStringLiteral("body_mesh_name_input"))->setText(lFile["body_mesh_name_input"].toString());

  this->findChild<QLineEdit*>(QStringLiteral("meshes_path_input_femalefeet"))->setText(lFile["meshes_path_input_femalefeet"].toString());
  this->findChild<QLineEdit*>(QStringLiteral("feet_mesh_name_input"))->setText(lFile["feet_mesh_name_input"].toString());

  this->findChild<QLineEdit*>(QStringLiteral("meshes_path_input_femalehands"))->setText(lFile["meshes_path_input_femalehands"].toString());
  this->findChild<QLineEdit*>(QStringLiteral("hands_mesh_name_input"))->setText(lFile["hands_mesh_name_input"].toString());

  this->findChild<QCheckBox*>(QStringLiteral("use_beast_hands"))->setChecked(lFile["use_beast_hands"].toBool());

  // Skeleton
  this->findChild<QCheckBox*>(QStringLiteral("use_custom_skeleton"))->setChecked(true); // Force to be true before putting the wanted value
  this->findChild<QLineEdit*>(QStringLiteral("skeleton_path_directory"))->setText(lFile["skeleton_path_directory"].toString());
  this->findChild<QLineEdit*>(QStringLiteral("skeleton_name"))->setText(lFile["skeleton_name"].toString());
  this->findChild<QCheckBox*>(QStringLiteral("use_custom_skeleton"))->setChecked(lFile["use_custom_skeleton"].toBool()); // Finish by checking or unchecking the box
  ...
  this->findChild<QLineEdit*>(QStringLiteral("names_osp_xml_input"))->setText(lFile["names_osp_xml_input"].toString());
  this->findChild<QLineEdit*>(QStringLiteral("names_bodyslide_input"))->setText(lFile["names_bodyslide_input"].toString());
  ...
  lMainDirTextEdit->setDisabled(lMainDirectory.isEmpty());

  this->findChild<QLineEdit*>(QStringLiteral("output_path_subdirectory"))->setText(lFile["output_path_subdirectory"].toString());
}
...
QJsonObject PresetCreator::saveValuesToJsonObject()
{
  ...
  // Body
  auto lMeshesPathBody{this->findChild<QLineEdit*>(QStringLiteral("meshes_path_input_femalebody"))->text().trimmed()};
  Utils::CleanPathString(lMeshesPathBody);
  lProject["meshes_path_input_femalebody"] = lMeshesPathBody;

  auto lBodyName{this->findChild<QLineEdit*>(QStringLiteral("body_mesh_name_input"))->text().trimmed()};
  Utils::CleanBreaksString(lBodyName);
  lProject["body_mesh_name_input"] = lBodyName;

  // Feet
  auto lMeshesPathFeet{this->findChild<QLineEdit*>(QStringLiteral("meshes_path_input_femalefeet"))->text().trimmed()};
  Utils::CleanPathString(lMeshesPathFeet);
  lProject["meshes_path_input_femalefeet"] = lMeshesPathFeet;

  auto lFeetName{this->findChild<QLineEdit*>(QStringLiteral("feet_mesh_name_input"))->text().trimmed()};
  Utils::CleanBreaksString(lFeetName);
  lProject["feet_mesh_name_input"] = lFeetName;

  // Hands
  auto lMeshesPathHands{this->findChild<QLineEdit*>(QStringLiteral("meshes_path_input_femalehands"))->text().trimmed()};
  Utils::CleanPathString(lMeshesPathHands);
  lProject["meshes_path_input_femalehands"] = lMeshesPathHands;

  auto lHandsName{this->findChild<QLineEdit*>(QStringLiteral("hands_mesh_name_input"))->text().trimmed()};
  Utils::CleanBreaksString(lHandsName);
  lProject["hands_mesh_name_input"] = lHandsName;

  // Use beast hands
  auto lMustUseBeastHands{this->findChild<QCheckBox*>(QStringLiteral("use_beast_hands"))->isChecked()};
  lProject["use_beast_hands"] = lMustUseBeastHands;

  // Use skeleton
  auto lMustCopySkeleton{this->findChild<QCheckBox*>(QStringLiteral("use_custom_skeleton"))->isChecked()};
  lProject["use_custom_skeleton"] = lMustCopySkeleton;

  // Skeleton path
  auto lSkeletonPath{this->findChild<QLineEdit*>(QStringLiteral("skeleton_path_directory"))->text().trimmed()};
  Utils::CleanPathString(lSkeletonPath);
  lProject["skeleton_path_directory"] = lSkeletonPath;

  // Skeleton name
  auto lSkeletonName{this->findChild<QLineEdit*>(QStringLiteral("skeleton_name"))->text()};
...
void PresetCreator::updateBeastHandsCheckboxState()
{
  ...
  auto lLabelBeastHands{this->findChild<QLabel*>(QStringLiteral("label_use_beast_hands"))};
  auto lMustUseBeastHands{this->findChild<QCheckBox*>(QStringLiteral("use_beast_hands"))};
...
void PresetCreator::populateSkeletonChooser()
{
  ...
  // Get the combobox
  const auto lSkeletonChooser{this->findChild<QComboBox*>(QStringLiteral("skeleton_chooser"))};
...
void PresetCreator::updateMeshesPreview()
{
  ...
  // Get preview label
  auto lPreviewLabel{this->findChild<QLabel*>(QStringLiteral("meshes_preview"))};
  ...
  if (!lMeshesPathBody.isEmpty())
  {
    ...
    if (!lMeshesPathBody.startsWith("meshes/", Qt::CaseSensitivity::CaseInsensitive) || (lMeshesPathBody.startsWith("meshes/", Qt::CaseSensitivity::CaseInsensitive) && lMeshesPathBody.length() < 8))
    {
  ...
  if (!lMeshesPathFeet.isEmpty())
  {
    ...
    if (lNewTextColor.compare(this->mSettings.display.successColor) == 0
        && (!lMeshesPathFeet.startsWith("meshes/", Qt::CaseSensitivity::CaseInsensitive) || (lMeshesPathFeet.startsWith("meshes/", Qt::CaseSensitivity::CaseInsensitive) && lMeshesPathFeet.length() < 8)))
    {
      lNewTextColor = this->mSettings.display.warningColor;
    }
  }
  ...
  if (!lMeshesPathHands.isEmpty())
  {
    ...
    if (lNewTextColor.compare(this->mSettings.display.successColor) == 0
        && (!lMeshesPathHands.startsWith("meshes/", Qt::CaseSensitivity::CaseInsensitive) || (lMeshesPathHands.startsWith("meshes/", Qt::CaseSensitivity::CaseInsensitive) && lMeshesPathHands.length() < 8)))
    {
      lNewTextColor = this->mSettings.display.warningColor;
    }
  }
...
{
  // Chooser
  auto lLabelChooser{this->findChild<QLabel*>(QStringLiteral("label_skeleton_chooser"))};
  auto lChooser{this->findChild<QComboBox*>(QStringLiteral("skeleton_chooser"))};
  auto lChooserRefresher{this->findChild<QPushButton*>(QStringLiteral("skeleton_chooser_refresher"))};
  auto lOpenAssetsDirectory{this->findChild<QPushButton*>(QStringLiteral("open_skeletons_assets_directory"))};

  // Directory
  auto lLabelPathDir{this->findChild<QLabel*>(QStringLiteral("label_skeleton_path_directory"))};
  auto lPathDir{this->findChild<QLineEdit*>(QStringLiteral("skeleton_path_directory"))};

  // Name
  auto lLabelSkeleton{this->findChild<QLabel*>(QStringLiteral("label_skeleton_female"))};
  auto lSkeleton{this->findChild<QLineEdit*>(QStringLiteral("skeleton_name"))};
  auto lSkeletonExtension{this->findChild<QLabel*>(QStringLiteral("skeleton_name_extension"))};

  // Preview
  auto lLabelPreview{this->findChild<QLabel*>(QStringLiteral("label_skeleton_path_preview"))};
  auto lPreview{this->findChild<QLabel*>(QStringLiteral("skeleton_path_preview"))};
...
void PresetCreator::updateSkeletonPreview()
{
  ...
  auto lSkeletonPath{this->findChild<QLineEdit*>(QStringLiteral("skeleton_path_directory"))->text()};
  Utils::CleanPathString(lSkeletonPath);
  auto lSkeletonName{this->findChild<QLineEdit*>(QStringLiteral("skeleton_name"))->text()};
  ...
  auto lOutputPathPreview{this->findChild<QLabel*>(QStringLiteral("skeleton_path_preview"))};

  QString lNewTextColor;

  if (lIsValidPath)
  {
    auto lStart{lSkeletonPath.startsWith("meshes/", Qt::CaseSensitivity::CaseInsensitive)};
  ...
  else if (this->findChild<QCheckBox*>(QStringLiteral("use_custom_skeleton"))->isChecked())
  {
    lNewTextColor = this->mSettings.display.dangerColor;
  }
...
void PresetCreator::generateDirectoryStructure()
{
  ...
  // Beast hands
  auto lCheckboxUseBeastHands{this->findChild<QCheckBox*>(QStringLiteral("use_beast_hands"))};
  ...
  // Feet meshes path and name
  const auto lInputMeshesPathFeet{this->findChild<QLineEdit*>(QStringLiteral("meshes_path_input_femalefeet"))};
  ...
  // Hands meshes path and name
  auto lInputMeshesPathHands{this->findChild<QLineEdit*>(QStringLiteral("meshes_path_input_femalehands"))};
  ...
  {
    // Read location
    auto lSourceSkeletonFileName{this->findChild<QComboBox*>(QStringLiteral("skeleton_chooser"))->currentText()};
    auto lSourceSkeletonReadPath{Utils::GetSkeletonsFolderPath().append(lSourceSkeletonFileName)};

    // Write location
    auto lDestinationSkeletonRelativePath{this->findChild<QLineEdit*>(QStringLiteral("skeleton_path_directory"))->text().trimmed()};
    Utils::CleanPathString(lDestinationSkeletonRelativePath);
    auto lDestinationSkeletonFileName{this->findChild<QLineEdit*>(QStringLiteral("skeleton_name"))->text()};
