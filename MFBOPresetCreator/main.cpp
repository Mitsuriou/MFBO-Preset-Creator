...
int main(int argc, char* argv[])
{
  ...
  do
  {
    ...
    QApplication::setApplicationVersion("2.9.5.0");
    ...
    if (lTranslator->load(QString("mfbopc_%1.qm").arg(lLanguageToSet), QLibraryInfo::location(QLibraryInfo::TranslationsPath)))
    {
