...
QString DataLists::getHandsSliderValue(const BodyNameVersion& aBody, const bool& aMustUseBeastHands)
{
...
QString DataLists::getFeetSliderValue(const BodyNameVersion& aBody, const int& aFeetModIndex)
{
...
QString DataLists::getBodySliderValue(const BodyNameVersion& aBody)
{
