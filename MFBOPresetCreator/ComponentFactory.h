...
public:
  ...
  // Full UI blocks
  static void createOutputBox(QWidget* aParent, QGridLayout* aLayout, const int& aLayoutRow, const int& aLayoutCol, const QString& aIconFolder, const QString& aInitialOutputPath = "", const int& aMinimumFirstColumnWidth = -1);
