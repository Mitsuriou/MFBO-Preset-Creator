...
namespace Tests
{
  ...
  public:
    TEST_METHOD(bool__QRCResourceExists__QString)
    {
      ...
      //------//
      // CBBE_3BA_3BBB
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::CBBE_3BA_3BBB_1_50, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::CBBE_3BA_3BBB_1_51_TO_1_55, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::CBBE_3BA_3BBB_2_02_TO_2_04, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::CBBE_3BA_3BBB_2_06_AND_2_11_AND_2_12, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::CBBE_3BA_3BBB_2_13_TO_2_18_AND_2_30_AND_2_31, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::CBBE_3BA_3BBB_2_40_TO_2_42, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      // CBBE_3BA_3BBB_NEVERNUDE
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::CBBE_3BA_3BBB_NEVERNUDE_2_13_TO_2_18_AND_2_30_AND_2_31, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::CBBE_3BA_3BBB_NEVERNUDE_2_40_TO_2_42, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      // CBBE_3BA_3BBB_UNDERWEAR
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::CBBE_3BA_3BBB_UNDERWEAR_2_13_TO_2_18_AND_2_30_AND_2_31, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::CBBE_3BA_3BBB_UNDERWEAR_2_40_TO_2_42, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      // BHUNP_3BBB
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_2_20, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_2_25, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_2_30, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_2_31, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_2_35_TO_2_42, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_3_00_TO_3_02, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      ...
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_ADVANCED_2_30, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_ADVANCED_2_31, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_ADVANCED_2_35_TO_2_42, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_ADVANCED_3_00_TO_3_02, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      ...
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_ADVANCED_VER_2_2_30, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_ADVANCED_VER_2_2_31, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_ADVANCED_VER_2_2_35_TO_2_42, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_ADVANCED_VER_2_3_00_TO_3_02, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      ...
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_BBP_2_30, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_BBP_2_31, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_BBP_2_35_TO_2_42, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_BBP_3_00_TO_3_02, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      ...
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_BBP_ADVANCED_2_30, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_BBP_ADVANCED_2_31, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_BBP_ADVANCED_2_35_TO_2_42, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_BBP_ADVANCED_3_00_TO_3_02, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      ...
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_TBBP_2_30, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_TBBP_2_31, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_TBBP_2_35_TO_2_42, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_TBBP_3_00_TO_3_02, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      ...
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_TBBP_ADVANCED_2_30, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_TBBP_ADVANCED_2_31, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_TBBP_ADVANCED_2_35_TO_2_42, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_TBBP_ADVANCED_3_00_TO_3_02, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      ...
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_ADVANCED_VER_2_NEVERNUDE_2_35_TO_2_42, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_ADVANCED_VER_2_NEVERNUDE_3_00_TO_3_02, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      ...
      // ASDASDF_3BBB
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::ASDASDF_3BBB_1_13, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      // ASDASDF_3BBB_NO_THIGH_JIGGLE
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::ASDASDF_3BBB_NO_THIGH_JIGGLE_1_13, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      // ASDASDF_BBP
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::ASDASDF_BBP_1_13, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      // ASDASDF_BBP_NO_THIGH_JIGGLE
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::ASDASDF_BBP_NO_THIGH_JIGGLE_1_13, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      // ASDASDF_TBBP
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::ASDASDF_TBBP_1_13, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      // ASDASDF_TBBP_NO_THIGH_JIGGLE
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::ASDASDF_TBBP_NO_THIGH_JIGGLE_1_13, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      // ASDASDF_ALTERBODY_3BBB
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::ASDASDF_ALTERBODY_3BBB_1_13, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      // ASDASDF_ALTERBODY_3BBB_NO_THIGH_JIGGLE
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::ASDASDF_ALTERBODY_3BBB_NO_THIGH_JIGGLE_1_13, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      // ASDASDF_ALTERBODY_BBP
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::ASDASDF_ALTERBODY_BBP_1_13, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      // ASDASDF_ALTERBODY_BBP_NO_THIGH_JIGGLE
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::ASDASDF_ALTERBODY_BBP_NO_THIGH_JIGGLE_1_13, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      // ASDASDF_ALTERBODY_TBBP
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::ASDASDF_ALTERBODY_TBBP_1_13, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      // ASDASDF_ALTERBODY_TBBP_NO_THIGH_JIGGLE
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::ASDASDF_ALTERBODY_TBBP_NO_THIGH_JIGGLE_1_13, FeetNameVersion::_INVALID_VALUE, BodyPartType::BODY)));
      ...
      // CBBE
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::CBBE_SMP_3BBB_1_2_0, FeetNameVersion::CBBE_1_6_1, BodyPartType::FEET)));
      // BHUNP 3BBB Advanced Feet
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_2_20, FeetNameVersion::BHUNP_3BBB_ADVANCED_2_20, BodyPartType::FEET)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_2_25, FeetNameVersion::BHUNP_3BBB_ADVANCED_2_25, BodyPartType::FEET)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_2_30, FeetNameVersion::BHUNP_3BBB_ADVANCED_2_30, BodyPartType::FEET)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_2_31, FeetNameVersion::BHUNP_3BBB_ADVANCED_2_31, BodyPartType::FEET)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_2_35_TO_2_42, FeetNameVersion::BHUNP_3BBB_ADVANCED_2_35_TO_2_42, BodyPartType::FEET)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_3_00_TO_3_02, FeetNameVersion::BHUNP_3BBB_ADVANCED_3_00_TO_3_02, BodyPartType::FEET)));
      ...
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::CBBE_3BA_3BBB_2_02_TO_2_04, FeetNameVersion::CBBE_3BA_3BBB_2_02_TO_2_04, BodyPartType::FEET)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::CBBE_3BA_3BBB_2_06_AND_2_11_AND_2_12, FeetNameVersion::CBBE_3BA_3BBB_2_06_AND_2_11_AND_2_12, BodyPartType::FEET)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::CBBE_3BA_3BBB_2_13_TO_2_18_AND_2_30_AND_2_31, FeetNameVersion::CBBE_3BA_3BBB_2_13_TO_2_18_AND_2_30_AND_2_31, BodyPartType::FEET)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::CBBE_3BA_3BBB_2_40_TO_2_42, FeetNameVersion::CBBE_3BA_3BBB_2_40_TO_2_42, BodyPartType::FEET)));
      // COCO_BODY_CBBE
      ...
      // ASDASDF
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::ASDASDF_3BBB_1_13, FeetNameVersion::ASDASDF_1_13, BodyPartType::FEET)));
      // MORE_SLIDERS_FOR_FEET
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::CBBE_3BA_3BBB_1_50, FeetNameVersion::MORE_SLIDERS_FOR_FEET_NORMAL_CBBE_1_0, BodyPartType::FEET)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_2_20, FeetNameVersion::MORE_SLIDERS_FOR_FEET_NORMAL_BHUNP_1_1, BodyPartType::FEET)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::CBBE_3BA_3BBB_1_50, FeetNameVersion::MORE_SLIDERS_FOR_FEET_HIGH_HEELS_CBBE_1_0, BodyPartType::FEET)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_2_20, FeetNameVersion::MORE_SLIDERS_FOR_FEET_HIGH_HEELS_BHUNP_1_1, BodyPartType::FEET)));
      // HG_FEET
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_2_20, FeetNameVersion::HG_FEET_1, BodyPartType::FEET)));
      // KHRYSAMERE_HG_FEET
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_2_20, FeetNameVersion::KHRYSAMERE_HG_FEET_1_0, BodyPartType::FEET)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_2_20, FeetNameVersion::KHRYSAMERE_HG_FEET_1_3_3, BodyPartType::FEET)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_2_20, FeetNameVersion::KHRYSAMERE_HG_FEET_1_4, BodyPartType::FEET)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_2_20, FeetNameVersion::KHRYSAMERE_HG_FEET_1_5, BodyPartType::FEET)));
      Assert::IsTrue(Utils::QRCResourceExists(DataLists::GetQRCPathForResource(BodyNameVersion::BHUNP_3BBB_2_20, FeetNameVersion::KHRYSAMERE_HG_FEET_1_6, BodyPartType::FEET)));
    }
  };
}
