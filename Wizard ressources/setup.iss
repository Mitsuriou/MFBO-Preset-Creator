...
french.DeleteAppDataDir=Voulez-vous supprimer les fichiers de configuration �galement ?%nCliquer sur "OUI" supprimera compl�tement le dossier "MFBOPresetCreator" situ� dans "%1".%nCliquer sur "NON" laissera les fichiers tels quels.
