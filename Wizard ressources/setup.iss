...
UninstallDisplayName=MFBO Preset Creator (v.2.4.0)
...
[Icons]
Name: "{autoprograms}\MFBO Preset Creator (v.2.4.0)"; Filename: "{app}\MFBOPresetCreator.exe"
Name: "{autodesktop}\MFBO Preset Creator (v.2.4.0)"; Filename: "{app}\MFBOPresetCreator.exe"; Tasks: desktopicon
